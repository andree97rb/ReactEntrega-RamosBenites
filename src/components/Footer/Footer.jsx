            ...
            <div className="container">
                <div className="row justify-content-between">
                    ...
                    <div className="col-md-4">
                        ...
                        <p className="mb-0 fs-6 fw-normal">RoyalCommerce es una empresa dedicada a la venta de computadoras y accesorios gamers de alta calidad. Nuestro enfoque es ayudar a los programadores y gamers a mejorar su setup para que puedan disfrutar de una experiencia de primer nivel.</p>
                    </div>
                </div>
                <hr className="my-4" />
